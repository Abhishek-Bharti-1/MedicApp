import 'package:medicapp/screens/forgot_password/page/forgot_password_page.dart';
import 'package:medicapp/screens/role_select/role_select_page.dart';
import 'package:medicapp/screens/sign_in/bloc/sign_in_bloc.dart';
import 'package:medicapp/screens/sign_in/widget/sign_in_content.dart';
import 'package:medicapp/screens/sign_up/page/sign_up_page.dart';
      ...
      child: BlocConsumer<SignInBloc, SignInState>(
        ...
        listener: (context, state) {
          if (state is NextForgotPasswordPageState) {
            ...
            Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (_) => RoleSelectPage()));
