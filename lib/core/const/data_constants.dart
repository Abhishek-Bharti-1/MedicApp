...
import 'package:medicapp/screens/onboarding/widget/onboarding_tile.dart';
...
class DataConstants {
  ...
  static final List<WorkoutData> homeWorkouts = [
    ...
    WorkoutData(
        title: TextConstants.cardioTitle2,
        exercices: TextConstants.cardioExercises2,
        minutes: TextConstants.cardioMinutes2,
        currentProgress: 1,
        progress: 20,
        image: PathConstants.cardio,
        exerciseDataList: [
